...
| `agent4ppt/generate_ppt.py` | 独立 PPT 生成 CLI | 完整可独立运行，当前未被 app.py 引用（保留备用） |
...
- `python -m py_compile app.py skill_router.py kb.py pm_agent.py hands_on_deck/scripts_deck.py agent4ppt/generate_ppt.py`
